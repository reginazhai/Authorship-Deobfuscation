...
def main():
    ...
    parser.add_argument("--datasetName", "-dn", help="Name of dataset to test with", default='BlogsAll')
    parser.add_argument("--allowedNeighbours", "-an", help="Total allowed neighbours in word embedding", default=5)
    parser.add_argument("--indexNumber", "-run", help="Number of run")
    ...
    ####################################################
        ...
        created_file_name = classifierType + "Results" + datasetName + str(authorstoKeep) + "/" + str(filename) + "/" + str(runNumber) + "_" + str(generation) + "_" + str(topK) + "_" \
                        + str(originalDocument.documentAuthorProbabilites[originalDocument.documentAuthor])\
                        + "_" + str(authorId) + "_" + str(originalDocument.documentAuthor) + ".csv"

        qualitative_results_folder = classifierType + "QualitativeResults" + datasetName + str(authorstoKeep) + "/" + filename + "/" + str(runNumber)
    ...
    ####################################################
        ...
        # Calculating Fitness
            ...
            for indivisual in indivisualsPopulation:
                ...
                outputResults.write(str(iteration_m) + "," + str(indivisual.fitnessScore) + "," + str(indivisual.classificationProbability) + "," + str(indivisual.totalReplacements) + "," + str(indivisual.documentAuthor) + "," + str(indivisual.meteorScore) + prob_str + "\n")
        ...
        # Selecting topK
            ...
            for topDocument in indivisualsPopulation:
                print('CURRENT PROBABILITY : ',topDocument.documentAuthorProbabilites[originalDocument.documentAuthor])
